...
SRC_URI = "git://github.com/tohas1986/phosphor-webui.git;branch=rikor-static"
SRCREV = "c01a33dd3f7905063de4a26b3e639b7f80c72c4e"
SRCREV = "${AUTOREV}"
# SRC_URI[md5sum] = "d64d0743f64c735c39f76e4b27f8ca97"
S = "${WORKDIR}/git"
